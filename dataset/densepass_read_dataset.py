...
class densepass_val(Dataset):
    ...
    def __init__(self, root, input_transform=None, target_transform=None, subset='val', target = True, crop_size=None, base_size=2048):
        ...
        self.pred_root = "/home/jinjing/zhengxu/SFUDA/SACF/KD_OnlyS"
        self.target = target
    ...
    def __getitem__(self, index):
        ...
        #print(self.pred_root)

        # with open(image_path_city(self.images_root, filename), 'rb') as f:
        #     image = load_image(f).convert('RGB')
        #print(image_path_city(self.pred_root, filename))
        path = filename.replace('/home/jinjing/zhengxu/SFUDA/data/DensePASS/leftImg8bit/val', '/home/jinjing/zhengxu/SFUDA/SACF/KD_OnlyS')
        print(path.replace('_', '_semantic'))
        with open(path.replace('_', '_'), 'rb') as f:
